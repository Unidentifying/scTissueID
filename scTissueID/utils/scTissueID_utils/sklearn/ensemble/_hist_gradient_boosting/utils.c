 ...
 *     cdef:
 */
  __pyx_tuple__26 = PyTuple_Pack(4, __pyx_n_s_array, __pyx_n_s_n_threads, __pyx_n_s_out, __pyx_n_s_i); if (unlikely(!__pyx_tuple__26)) __PYX_ERR(0, 142, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_tuple__26);
  __Pyx_GIVEREF(__pyx_tuple__26);
  __pyx_codeobj__27 = (PyObject*)__Pyx_PyCode_New(2, 0, 4, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__26, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_sklearn_ensemble__hist_gradient, __pyx_n_s_sum_parallel, 142, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__27)) __PYX_ERR(0, 142, __pyx_L1_error)
