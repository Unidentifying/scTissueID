...
static PyObject *__pyx_pw_7sklearn_8ensemble_23_hist_gradient_boosting_10_predictor_1_predict_from_raw_data(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __Pyx_RefNannySetupContext("_predict_from_raw_data (wrapper)", 0);
  {
    ...
    __pyx_v_nodes = __Pyx_PyObject_to_MemoryviewSlice_ds_nn_struct____pyx_t_7sklearn_8ensemble_23_hist_gradient_boosting_6common_node_struct(values[0], PyBUF_WRITABLE); if (unlikely(!__pyx_v_nodes.memview)) __PYX_ERR(0, 17, __pyx_L3_error)
