#############################
#LDA
#Run: python3 LDA.py example/trains.csv example/trainslabel.csv example/tests.csv example/testslabel.csv ./
#Input args:
#	Input: 
...
truelab.to_csv(str(Output/Path("LDAtruelabel.csv")), index = False)
pred.to_csv(str(Output/Path("LDApredlabel.csv")), index = False)    
